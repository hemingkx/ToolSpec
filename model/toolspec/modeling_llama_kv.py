...
"""PyTorch LLaMA model with ToolSpec KV-cache extensions."""
import math
import warnings
...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        if attention_mask is not None and attention_mask.dim() == 4:
            # toolspec passes a pre-built 4D tree mask; do not rebuild/convert it.
            # SDPA accepts bool/float masks, so only coerce unsupported dtypes.
